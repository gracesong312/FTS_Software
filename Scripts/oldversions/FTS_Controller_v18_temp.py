...
######################################################################################################################
    ...
    def find_zopd(self):
        ...
        def zopd_scan():
            ...
            self.run_scan(-1,150,2,5,400,thread_text,finished_text,"finished()",determine_zopd,True,False) #Slew 10mm to the left in steps of .1mm at 1mm/s
        ...
        self.run_scan(5,75,2,5,400,status_text,status_text,"finished()",zopd_scan,False,False) #Slew 5mm to the right in steps of .1mm at 1mm/s
...
######################################################################################################################
    ...
    def write_fits(self,fname):
        ...
        prihdr['SOURCE'] = (str(self.source), 'Name of the source used.')
        ...
        prihdr['FILTER'] = (str(self.filtname),'Description of the filter used.')
    ...
    def on_submit(self):
        ...
        if self.inputs_confirmed:
            ...
            def full_scan():
                ...
                self.samp_rate,thread_text,finished_text,"finished()",self.save,True,False) 
                    
            #Now run the scan
            status_text = 'Performing scan'
            self.run_scan(5*self.step_size,.5*self.throw,self.num_sample,self.speed,self.samp_rate,
