    ...
    def on_submit(self):
        ...
        if self.inputs_confirmed:
            ...
            def full_scan():
                ...
                self.run_scan(-.1,200,1,thread_text,finished_text,"finished()",self.save,True,False)
                    
            #Now run the scan
            status_text = 'Performing scan'
            self.run_scan(.1,100,1,status_text,status_text,"finished()",full_scan,False,False)
